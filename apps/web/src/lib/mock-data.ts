...
export const MOCK_ATHLETE_RESULTS: AthleteResult[] = [
  {
    ...
    event: { id: "e1", source_id: "2149044", name: "2025 Sun Belt XC Championship", date: "2025-10-31", location: "Troy, AL", gender: "Women", distance: "5K", season: "xc", division: null, provider: "legacy_spa", source_url: null },
    splits: [
